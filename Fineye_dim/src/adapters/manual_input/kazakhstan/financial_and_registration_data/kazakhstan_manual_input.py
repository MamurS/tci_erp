...
class KazakhstanManualInputAdapterFinancialAndRegistrationData(BaseManualInputFinancialAndRegistrationDataAdapter):
    ...
    async def adapt_data(self) -> DataForInsertionModuleScheme:
        ...
        COUNTRY_MONGOLIA = COUNTRY_MAPPING["Kazakhstan"]
        CURRENCY_MNT = CURRENCY_MAPPING["KZT"]
        ...
        try:
            registration_identifier_name = "БИН/ИИН"
        ...
        if owners_identifier and owners_full_name:
            ...
            self.data["persons"]["person_1"] = PersonScheme(
                ...
                gender=None,
                citizenship=None,
                identifier_name="Registration no.",  # TODO
