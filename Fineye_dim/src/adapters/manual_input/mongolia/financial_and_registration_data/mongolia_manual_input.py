...
class MongoliaManualInputAdapterFinancialAndRegistrationData(BaseManualInputFinancialAndRegistrationDataAdapter):
    ...
    async def adapt_data(self) -> DataForInsertionModuleScheme:
        ...
        COUNTRY_MONGOLIA = COUNTRY_MAPPING["Mongolia"]
        CURRENCY_MNT = CURRENCY_MAPPING["MNT"]
